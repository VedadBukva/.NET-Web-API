...
## How to run? 
Load project folder in Visual Studio Code (or just open terminal in root of project folder) and run the ASP.NET Core application with the following line of code in terminal:
```
dotnet run
```
